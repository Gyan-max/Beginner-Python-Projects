...
class ContactBookApp:
    def __init__(self, master):
        ...
        # self.master.iconbitmap("contact2.ico.sketch")
    ...
    #         self.contact_listbox.insert(tk.END, contact.get("name", "No Name"))
    ...
    def restore_contact(self):
            if self.deleted_contacts:
                contact = self.deleted_contacts.pop()
                self.contacts.append(contact)
                self.contact_listbox.insert(tk.END, contact["name"])  # Use contact dictionary
    ...
    def load_contacts(self):
        ...
        # messagebox.showinfo("Contacts Loaded", "Contacts loaded successfully.")
